...
The following terms are builder-recorded metadata at pinned revisions, not independent verification of every licensor's rights. Dataset authors and contributors retain their rights. Exact mixture and transport revisions are preserved in docs/petitgpt-v1/tables/PRETRAIN_SOURCE_MIXTURE.csv.
...
No raw corpus, frozen evaluation prompts or model answers are distributed. Author licensing does not relicense upstream datasets or clear third-party rights. See docs/petitgpt-v1/DOCUMENTATION_LICENSE.md for the scoped grant.
