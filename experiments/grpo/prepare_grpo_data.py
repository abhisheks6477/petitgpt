...
"""
Build a prompts-only JSONL bank for GRPO (experiments/grpo/grpo.py).
...
Example:
    python experiments/grpo/prepare_grpo_data.py \\
      --code_bank dataset/distill/code_canonical_prompts.jsonl \\
      --tokenizer_path tokenizer/releases/tokenizer_v1/tokenizer.json --out_dir datasets/grpo \\
