...
_SUCCESSOR_CODE_ROOT = Path("artifacts/base_recovery").resolve()
...
SUCCESSOR_REPOSITORY_ROOT = Path("artifacts/base_recovery")
...
def observe_successor_identity() -> dict[str, Any]:
    ...
    _require(
        ...
        "successor bridge must execute from the canonical . CWD",
    )
    _require(
